...
본 이용약관은 "Genius Game"(이하 "지니어스 게임")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.

## 제2조 용어의 정의

본 약관에서 사용되는 주요한 용어의 정의는 다음과 같습니다.

① **회원/플레이어** : 사이트의 약관에 동의하고 개인정보를 제공하여 회원등록을 한 자로서, 사이트와의 이용계약을 체결하고 사이트를 이용하는 이용자를 말합니다.
...
① 본 사이트에서 게시되는 문제 또는 컨텐츠의 무단 배포 및 사용을 금합니다.

## 부칙

이 약관은 **2025. 3. 17.** 부터 시행합니다.